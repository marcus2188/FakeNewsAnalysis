...
# CONFUSION MATRIX FOR TRUE POSITIVES AND NEGATIVES
print("Training set Confusion Matrix : ")
cfmtrain = confusion_matrix(ytrain, grid.predict(xtrainvec))
print(cfmtrain)
print("True Positive: ", cfmtrain[1][1], "\nTrue Negative: ", cfmtrain[0][0], "\nFalse Positive: ", cfmtrain[0][1], "\nFalse Negative: ", cfmtrain[1][0])
print()
print("Test set Confusion Matrix : ")
testpred = grid.predict(xtestvec)
cfmtest = confusion_matrix(ytest, testpred)
print(cfmtest)
print("True Positive: ", cfmtest[1][1], "\nTrue Negative: ", cfmtest[0][0], "\nFalse Positive: ", cfmtest[0][1], "\nFalse Negative: ", cfmtest[1][0])
print()
print("General scores for confusion: ")
print("Precision(Positivity rate): ", cfmtest[1][1]/(cfmtest[1][1] + cfmtest[0][1]))
print("Recall(Positivity Error):", cfmtest[1][1]/(cfmtest[1][1] + cfmtest[1][0]))
